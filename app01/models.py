...
class UserInfo(models.Model):
    ...
    salary = models.DecimalField(verbose_name="工资", max_digits=10, decimal_places=3, default=0, null=True, blank=True)
...
class BaseInfoWorkHour(models.Model):
    ...
    单价 = models.DecimalField(max_digits=10, decimal_places=3, null=True)
...
class PlanPlantBatch(models.Model):
    ...
    移栽数量 = models.DecimalField(max_digits=10, decimal_places=3, null=True)
    移栽板量 = models.DecimalField(max_digits=10, decimal_places=3, null=True)
    点子数量 = models.DecimalField(max_digits=10, decimal_places=3, null=True)
    地块 = models.CharField(max_length=255, null=True)
    备注 = models.CharField(max_length=255, null=True)
    生长周期 = models.DecimalField(max_digits=10, decimal_places=3, null=True)
    ...
    总周期天数 = models.DecimalField(max_digits=10, decimal_places=3, null=True)
    销毁面积 = models.DecimalField(max_digits=10, decimal_places=3, null=True)
    销毁备注 = models.DecimalField(max_digits=10, decimal_places=3, null=True)
    栽种方式 = models.CharField(max_length=255, null=True)
    正常产量 = models.DecimalField(max_digits=10, decimal_places=3, null=True)
    正常亩产 = models.DecimalField(max_digits=10, decimal_places=3, null=True)
    总产量 = models.DecimalField(max_digits=10, decimal_places=3, null=True)
    总亩产 = models.DecimalField(max_digits=10, decimal_places=3, null=True)
...
class ProductionBatch(models.Model):
    ...
    总周期 = models.DecimalField(max_digits=10, decimal_places=3, null=True)
    实际总产量 = models.DecimalField(max_digits=10, decimal_places=3, null=True)
    正常总产量 = models.DecimalField(max_digits=10, decimal_places=3, null=True)
    总亩产量 = models.DecimalField(max_digits=10, decimal_places=3, null=True)
    正常亩产量 = models.DecimalField(max_digits=10, decimal_places=3, null=True)


class CostTotal(models.Model):
    批次 = models.CharField(max_length=255, null=True)
    人工费用 = models.DecimalField(max_digits=10, decimal_places=3, null=True)
    农资费用 = models.DecimalField(max_digits=10, decimal_places=3, null=True)
    打药费用 = models.DecimalField(max_digits=10, decimal_places=3, null=True)
    打地费用 = models.DecimalField(max_digits=10, decimal_places=3, null=True)
    折旧费用 = models.DecimalField(max_digits=10, decimal_places=3, null=True)
    出库 = models.DecimalField(max_digits=10, decimal_places=3, null=True)
    销售 = models.DecimalField(max_digits=10, decimal_places=3, null=True)


class PlanSummary(models.Model):
    移栽时间 = models.DateField(null=True)
    批次ID = models.CharField(max_length=255, null=True)
    计划种植 = models.DecimalField(max_digits=10, decimal_places=3, null=True)
    实际种植 = models.DecimalField(max_digits=10, decimal_places=3, null=True)
    计划达成率 = models.DecimalField(max_digits=10, decimal_places=3, null=True)
    生长周期 = models.DecimalField(max_digits=10, decimal_places=3, null=True)
    踩栽周期 = models.DateField(null=True)
    踩栽末期 = models.DateField(null=True)
    下一批前一天 = models.DateField(null=True)
    损耗 = models.DecimalField(max_digits=10, decimal_places=3, null=True)
    实际采收 = models.DecimalField(max_digits=10, decimal_places=3, null=True)
    计划实际采收率 = models.DecimalField(max_digits=10, decimal_places=3, null=True)
    预估客销售 = models.DecimalField(max_digits=10, decimal_places=3, null=True)
    实际销售 = models.DecimalField(max_digits=10, decimal_places=3, null=True)
    计划销售率 = models.DecimalField(max_digits=10, decimal_places=3, null=True)
...
class ProductionWage(models.Model):
    ...
    工时 = models.DecimalField(max_digits=10, decimal_places=3, null=True)
    数量 = models.DecimalField(max_digits=10, decimal_places=3, null=True)
    工价 = models.DecimalField(max_digits=10, decimal_places=3, null=True)
    累计工时 = models.DecimalField(max_digits=10, decimal_places=3, null=True)
    合计工资 = models.DecimalField(max_digits=10, decimal_places=3, null=True)
    批次 = models.CharField(max_length=255, null=True)
    地块 = models.CharField(max_length=255, null=True)
...
class CostAgriculture(models.Model):
    批次 = models.CharField(max_length=255, null=True)
    地块 = models.DecimalField(max_digits=10, decimal_places=3, null=True)
    单据编号 = models.DecimalField(max_digits=10, decimal_places=3, null=True)
    商品全名 = models.DecimalField(max_digits=10, decimal_places=3, null=True)
    规格 = models.DecimalField(max_digits=10, decimal_places=3, null=True)
    数量 = models.DecimalField(max_digits=10, decimal_places=3, null=True)
    单位 = models.DecimalField(max_digits=10, decimal_places=3, null=True)
    单价 = models.DecimalField(max_digits=10, decimal_places=3, null=True)
    金额 = models.DecimalField(max_digits=10, decimal_places=3, null=True)
    备注 = models.CharField(max_length=255, null=True)
...
class CostPesticide(models.Model):
    ...
    地块 = models.DecimalField(max_digits=10, decimal_places=3, null=True)
    面积 = models.DecimalField(max_digits=10, decimal_places=3, null=True)
    实际打药面积 = models.DecimalField(max_digits=10, decimal_places=3, null=True)
    数量 = models.DecimalField(max_digits=10, decimal_places=3, null=True)
    单位 = models.DecimalField(max_digits=10, decimal_places=3, null=True)
    单价 = models.DecimalField(max_digits=10, decimal_places=3, null=True)
    金额 = models.DecimalField(max_digits=10, decimal_places=3, null=True)
...
class CostAllocation(models.Model):
    ...
    散装工时 = models.DecimalField(max_digits=10, decimal_places=3, null=True)
    农家肥 = models.DecimalField(max_digits=10, decimal_places=3, null=True)
    材料 = models.DecimalField(max_digits=10, decimal_places=3, null=True)
    管理费 = models.DecimalField(max_digits=10, decimal_places=3, null=True)
    生活费 = models.DecimalField(max_digits=10, decimal_places=3, null=True)
    水电费 = models.DecimalField(max_digits=10, decimal_places=3, null=True)
    地租 = models.DecimalField(max_digits=10, decimal_places=3, null=True)
    大棚管架 = models.DecimalField(max_digits=10, decimal_places=3, null=True)
    大棚棚膜 = models.DecimalField(max_digits=10, decimal_places=3, null=True)
    大棚喷灌 = models.DecimalField(max_digits=10, decimal_places=3, null=True)
    其他资产 = models.DecimalField(max_digits=10, decimal_places=3, null=True)
    有机肥 = models.DecimalField(max_digits=10, decimal_places=3, null=True)
    出勤奖 = models.DecimalField(max_digits=10, decimal_places=3, null=True)
    服务费 = models.DecimalField(max_digits=10, decimal_places=3, null=True)
    基地经理 = models.DecimalField(max_digits=10, decimal_places=3, null=True)
    批次 = models.CharField(max_length=255, null=True)
...
class SalesOutbound(models.Model):
    ...
    数量 = models.DecimalField(max_digits=10, decimal_places=3, null=True)
    单位 = models.DecimalField(max_digits=10, decimal_places=3, null=True)
    重量 = models.DecimalField(max_digits=10, decimal_places=3, null=True)
    地块 = models.CharField(max_length=255, null=True)
    批次 = models.CharField(max_length=255, null=True)
...
class SalesDetail(models.Model):
    ...
    单价 = models.DecimalField(max_digits=10, decimal_places=3, null=True)
    重量 = models.DecimalField(max_digits=10, decimal_places=3, null=True)
    销售额 = models.DecimalField(max_digits=10, decimal_places=3, null=True)
    批次 = models.CharField(max_length=255, null=True)
    地块 = models.CharField(max_length=255, null=True)
...
class SalesSummary(models.Model):
    ...
    批次 = models.CharField(max_length=255, null=True)
    单价 = models.DecimalField(max_digits=10, decimal_places=3, null=True)
    应收金额 = models.DecimalField(max_digits=10, decimal_places=3, null=True)
    实收金额 = models.DecimalField(max_digits=10, decimal_places=3, null=True)
    应收金额合计 = models.DecimalField(max_digits=10, decimal_places=3, null=True)
    实收金额合计 = models.DecimalField(max_digits=10, decimal_places=3, null=True)
    差额 = models.DecimalField(max_digits=10, decimal_places=3, null=True)
    合计框数 = models.DecimalField(max_digits=10, decimal_places=3, null=True)
    上车拨入框数 = models.DecimalField(max_digits=10, decimal_places=3, null=True)
    本车拨入框数 = models.DecimalField(max_digits=10, decimal_places=3, null=True)
    备注 = models.CharField(max_length=255, null=True)
...
class Plant_batch(models.Model):
    ...
    生长周期 = models.DecimalField(max_digits=10, decimal_places=3, null=True, blank=True)
    ...
    总周期天数 = models.DecimalField(max_digits=10, decimal_places=3, null=True, blank=True)
    销毁面积 = models.DecimalField(max_digits=10, decimal_places=3, null=True, blank=True)
    销毁备注 = models.CharField(max_length=255, null=True, blank=True)
    栽种方式 = models.CharField(max_length=255, null=True, blank=True)
    正常产量 = models.DecimalField(max_digits=10, decimal_places=3, null=True, blank=True)
    正常亩产 = models.DecimalField(max_digits=10, decimal_places=3, null=True, blank=True)
    总产量 = models.DecimalField(max_digits=10, decimal_places=3, null=True, blank=True)
    总亩产 = models.DecimalField(max_digits=10, decimal_places=3, null=True, blank=True)
    ...
    打地周期 = models.DecimalField(max_digits=10, decimal_places=3, null=True, blank=True)
    ...
    移栽周期 = models.DecimalField(max_digits=10, decimal_places=3, null=True, blank=True)
    移栽数量 = models.FloatField(null=True, blank=True)

    除草开始时间 = models.DateField(null=True, blank=True)
    除草结束时间 = models.DateField(null=True, blank=True)
    除草周期 = models.DecimalField(max_digits=10, decimal_places=3, null=True, blank=True)
    ...
    采收周期 = models.DecimalField(max_digits=10, decimal_places=3, null=True, blank=True)
    ...
    清棚周期 = models.DecimalField(max_digits=10, decimal_places=3, null=True, blank=True)
    ...
    点籽周期 = models.DecimalField(max_digits=10, decimal_places=3, null=True, blank=True)
    ...
    间菜周期 = models.DecimalField(max_digits=10, decimal_places=3, null=True, blank=True)
    ...
    吹生菜周期 = models.DecimalField(max_digits=10, decimal_places=3, null=True, blank=True)
    ...
    施肥周期 = models.DecimalField(max_digits=10, decimal_places=3, null=True, blank=True)
...
class Salary_by_plople(models.Model):
    ...
    清棚 = models.DecimalField(max_digits=10, decimal_places=3)
    点籽 = models.DecimalField(max_digits=10, decimal_places=3)
    移栽 = models.DecimalField(max_digits=10, decimal_places=3)
    锄草 = models.DecimalField(max_digits=10, decimal_places=3)
    间菜 = models.DecimalField(max_digits=10, decimal_places=3)
    拔草 = models.DecimalField(max_digits=10, decimal_places=3)
    打药 = models.DecimalField(max_digits=10, decimal_places=3)
    施肥 = models.DecimalField(max_digits=10, decimal_places=3)
    吹生菜 = models.DecimalField(max_digits=10, decimal_places=3)
    插竹竿绑线 = models.DecimalField(max_digits=10, decimal_places=3)
    收菜 = models.DecimalField(max_digits=10, decimal_places=3)
    清废菜 = models.DecimalField(max_digits=10, decimal_places=3)
    绑线 = models.DecimalField(max_digits=10, decimal_places=3)
    散工 = models.DecimalField(max_digits=10, decimal_places=3)
    修枝 = models.DecimalField(max_digits=10, decimal_places=3)
    绑枝 = models.DecimalField(max_digits=10, decimal_places=3)
    插竹竿 = models.DecimalField(max_digits=10, decimal_places=3)
    其它 = models.DecimalField(max_digits=10, decimal_places=3)
    铲沟草 = models.DecimalField(max_digits=10, decimal_places=3)
    锄拔草 = models.DecimalField(max_digits=10, decimal_places=3)
    合计工时 = models.DecimalField(max_digits=10, decimal_places=3)
    合计工资 = models.DecimalField(max_digits=10, decimal_places=3)
    平均工资 = models.DecimalField(max_digits=10, decimal_places=3)
...
class Salary_by_daily(models.Model):
    ...
    day_1 = models.DecimalField(max_digits=10, decimal_places=3)
    day_2 = models.DecimalField(max_digits=10, decimal_places=3)
    day_3 = models.DecimalField(max_digits=10, decimal_places=3)
    day_4 = models.DecimalField(max_digits=10, decimal_places=3)
    day_5 = models.DecimalField(max_digits=10, decimal_places=3)
    day_6 = models.DecimalField(max_digits=10, decimal_places=3)
    day_7 = models.DecimalField(max_digits=10, decimal_places=3)
    day_8 = models.DecimalField(max_digits=10, decimal_places=3)
    day_9 = models.DecimalField(max_digits=10, decimal_places=3)
    day_10 = models.DecimalField(max_digits=10, decimal_places=3)
    day_11 = models.DecimalField(max_digits=10, decimal_places=3)
    day_12 = models.DecimalField(max_digits=10, decimal_places=3)
    day_13 = models.DecimalField(max_digits=10, decimal_places=3)
    day_14 = models.DecimalField(max_digits=10, decimal_places=3)
    day_15 = models.DecimalField(max_digits=10, decimal_places=3)
    day_16 = models.DecimalField(max_digits=10, decimal_places=3)
    day_17 = models.DecimalField(max_digits=10, decimal_places=3)
    day_18 = models.DecimalField(max_digits=10, decimal_places=3)
    day_19 = models.DecimalField(max_digits=10, decimal_places=3)
    day_20 = models.DecimalField(max_digits=10, decimal_places=3)
    day_21 = models.DecimalField(max_digits=10, decimal_places=3)
    day_22 = models.DecimalField(max_digits=10, decimal_places=3)
    day_23 = models.DecimalField(max_digits=10, decimal_places=3)
    day_24 = models.DecimalField(max_digits=10, decimal_places=3)
    day_25 = models.DecimalField(max_digits=10, decimal_places=3)
    day_26 = models.DecimalField(max_digits=10, decimal_places=3)
    day_27 = models.DecimalField(max_digits=10, decimal_places=3)
    day_28 = models.DecimalField(max_digits=10, decimal_places=3)
    day_29 = models.DecimalField(max_digits=10, decimal_places=3)
    day_30 = models.DecimalField(max_digits=10, decimal_places=3)
    day_31 = models.DecimalField(max_digits=10, decimal_places=3)
    合计 = models.DecimalField(max_digits=10, decimal_places=3)
...
class Workhour_by_daily(models.Model):
    ...
    day_31 = models.DecimalField(max_digits=10, decimal_places=3)
    合计工时 = models.DecimalField(max_digits=10, decimal_places=3)
    累积工时 = models.DecimalField(max_digits=10, decimal_places=3)
...
class ExpenseAllocation(models.Model):
    ...
    散工工时 = models.DecimalField(max_digits=10, decimal_places=3, verbose_name="散工工时")
    浇水打杂费用 = models.DecimalField(max_digits=10, decimal_places=3, verbose_name="浇水打杂费用")
    材料费 = models.DecimalField(max_digits=10, decimal_places=3, verbose_name="材料费")
    管理费1 = models.DecimalField(max_digits=10, decimal_places=3, verbose_name="管理费1")
    生活费 = models.DecimalField(max_digits=10, decimal_places=3, verbose_name="生活费")
    水电费 = models.DecimalField(max_digits=10, decimal_places=3, verbose_name="水电费")
    报销费用 = models.DecimalField(max_digits=10, decimal_places=3, verbose_name="报销费用")
    其他费用 = models.DecimalField(max_digits=10, decimal_places=3, verbose_name="其他费用")
    地租 = models.DecimalField(max_digits=10, decimal_places=3, verbose_name="地租")
    其他资产 = models.DecimalField(max_digits=10, decimal_places=3, verbose_name="其他资产")
    农家肥 = models.DecimalField(max_digits=10, decimal_places=3, verbose_name="农家肥")
    有机肥 = models.DecimalField(max_digits=10, decimal_places=3, verbose_name="有机肥")
    草莓土 = models.DecimalField(max_digits=10, decimal_places=3, verbose_name="草莓土")
    出勤奖 = models.DecimalField(max_digits=10, decimal_places=3, verbose_name="出勤奖")
    服务费 = models.DecimalField(max_digits=10, decimal_places=3, verbose_name="服务费")
    地租大棚摊销 = models.DecimalField(max_digits=10, decimal_places=3, verbose_name="地租大棚摊销")
    基地经理 = models.CharField(max_length=100)
    燃油费 = models.DecimalField(max_digits=10, decimal_places=3, verbose_name="燃油费", default=0)
    维修费 = models.DecimalField(max_digits=10, decimal_places=3, verbose_name="维修费", default=0)
    销售费 = models.DecimalField(max_digits=10, decimal_places=3, verbose_name="销售费", default=0)
    class Meta:
        verbose_name = "费用摊销"
...
class DepreciationAllocation(models.Model):
    地租 = models.DecimalField(max_digits=10, decimal_places=3, verbose_name="地租")
    大棚管架 = models.DecimalField(max_digits=10, decimal_places=3, verbose_name="大棚管架")
    大棚棚膜 = models.DecimalField(max_digits=10, decimal_places=3, verbose_name="大棚棚膜")
    大棚喷灌 = models.DecimalField(max_digits=10, decimal_places=3, verbose_name="大棚喷灌")
    其他资产 = models.DecimalField(max_digits=10, decimal_places=3, verbose_name="其他资产")
    材料 = models.DecimalField(max_digits=10, decimal_places=3, verbose_name="材料")
...
class LossReport(models.Model):
    ...
    报损数量 = models.DecimalField(max_digits=10, decimal_places=3, verbose_name="报损数量")
    报损单位 = models.CharField(max_length=50, verbose_name="报损单位")
    报损面积 = models.DecimalField(max_digits=10, decimal_places=3, null=True, blank=True)  # 新增报损面积
...
class OutboundRecord(models.Model):
    ...
    数量_筐 = models.DecimalField(max_digits=10, decimal_places=3, verbose_name="数量/筐")
    重量_kg = models.DecimalField(max_digits=10, decimal_places=3, verbose_name="重量/kg")
...
class SalesRecord(models.Model):
    ...
    数量 = models.DecimalField(max_digits=10, decimal_places=3, verbose_name="数量", default=0)
    单价 = models.DecimalField(max_digits=10, decimal_places=3, verbose_name="单价", default=0)
    金额 = models.DecimalField(max_digits=10, decimal_places=3, verbose_name="金额", default=0)
    应收金额 = models.DecimalField(max_digits=10, decimal_places=3, verbose_name="应收金额", default=0)
    实收金额 = models.DecimalField(max_digits=10, decimal_places=3, verbose_name="实收金额", default=0)
    备注 = models.TextField(verbose_name="备注", null=True, blank=True)
    # 新增字段
    ...
    实销筐数 = models.DecimalField(max_digits=10, decimal_places=3, verbose_name="实销筐数", default=0)  # 新增字段
...
class V_Profit_Summary(models.Model):
    ...
    工时费 = models.DecimalField(max_digits=10, decimal_places=3, null=True, blank=True)
    农资费用 = models.DecimalField(max_digits=10, decimal_places=3, null=True, blank=True)
    散工工时 = models.DecimalField(max_digits=10, decimal_places=3, null=True, blank=True)
    浇水打杂费用 = models.DecimalField(max_digits=10, decimal_places=3, null=True, blank=True)
    材料费 = models.DecimalField(max_digits=10, decimal_places=3, null=True, blank=True)
    管理费 = models.DecimalField(max_digits=10, decimal_places=3, null=True, blank=True)
    生活费 = models.DecimalField(max_digits=10, decimal_places=3, null=True, blank=True)
    水电费 = models.DecimalField(max_digits=10, decimal_places=3, null=True, blank=True)
    报销费用 = models.DecimalField(max_digits=10, decimal_places=3, null=True, blank=True)
    其他费用 = models.DecimalField(max_digits=10, decimal_places=3, null=True, blank=True)
    地租 = models.DecimalField(max_digits=10, decimal_places=3, null=True, blank=True)
    其他资产 = models.DecimalField(max_digits=10, decimal_places=3, null=True, blank=True)
    农家肥 = models.DecimalField(max_digits=10, decimal_places=3, null=True, blank=True)
    有机肥 = models.DecimalField(max_digits=10, decimal_places=3, null=True, blank=True)
    草莓土 = models.DecimalField(max_digits=10, decimal_places=3, null=True, blank=True)
    出勤奖金 = models.DecimalField(max_digits=10, decimal_places=3, null=True, blank=True)
    服务费 = models.DecimalField(max_digits=10, decimal_places=3, null=True, blank=True)
    地租大棚摊销 = models.DecimalField(max_digits=10, decimal_places=3, null=True, blank=True)
    燃油费 = models.DecimalField(max_digits=10, decimal_places=3, null=True, blank=True)
    维修费 = models.DecimalField(max_digits=10, decimal_places=3, null=True, blank=True)
    销售费 = models.DecimalField(max_digits=10, decimal_places=3, null=True, blank=True)
    销售收入 = models.DecimalField(max_digits=10, decimal_places=3, null=True, blank=True)
    总成本 = models.DecimalField(max_digits=10, decimal_places=3, null=True, blank=True)
    利润 = models.DecimalField(max_digits=10, decimal_places=3, null=True, blank=True)
...
class DailyPriceReport(models.Model):
    ...
    价格 = models.DecimalField(verbose_name="价格", max_digits=10, decimal_places=3)
    价格上限 = models.DecimalField(verbose_name="价格上限", max_digits=10, decimal_places=3, null=True, blank=True)
...
class MonthlyPlan(models.Model):
    ...
    面积 = models.DecimalField(max_digits=10, decimal_places=3)  # 面积单位：亩
    周期 = models.IntegerField()  # 周期单位：天
    每天种植单位亩 = models.DecimalField(max_digits=10, decimal_places=3,default=0)  # 每天种植单位亩
    每天产量单位吨 = models.DecimalField(max_digits=10, decimal_places=3,default=0)  # 每天产量单位吨
    五天种植单位亩 = models.DecimalField(max_digits=10, decimal_places=3,default=0)  # 5天种植单位亩
...
class DailyPlan(models.Model):
    ...
    地块 = models.CharField(max_length=255, verbose_name="地块")
    面积 = models.DecimalField(max_digits=10, decimal_places=3, verbose_name="面积")
...
class BatchCost(models.Model):
    批次ID = models.CharField(max_length=50)
    计划内成本 = models.DecimalField(max_digits=10, decimal_places=3)
